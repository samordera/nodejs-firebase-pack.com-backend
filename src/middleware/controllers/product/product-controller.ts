...
export class ProductController implements Controller {
    ...
    initialize(httpServer: HttpServer,): void {
        httpServer.post('/product', this.createProduct.bind(this), ['seller']);
        ...
        httpServer.get ('/all-products-public', this.getProductListPublic.bind(this), ['buyer', 'seller']);
        httpServer.get ('/product/:productId', this.getProductByIdPublic.bind(this), ['authenticated']);

        httpServer.get ('/product/:productId/full-details', this.getProductByIdFull.bind(this), ['seller']);
        httpServer.put ('/product/:productId', this.updateProductById.bind(this), ['seller']);
    }
