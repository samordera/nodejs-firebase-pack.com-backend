...
export class PartialProductClientModel {
    private static _validate(body:any) {
        ...
        if (body[ProductClientModel.kLowerSalePriceLimit]) validateProductPrice(body[ProductClientModel.kLowerSalePriceLimit]);
    ...
    static validate (body:any) : Partial<Record<keyof Product, any>> {
        ...
        if (body[ProductClientModel.kLowerSalePriceLimit]) res.lowerSalePriceLimit = body[ProductClientModel.kLowerSalePriceLimit];
